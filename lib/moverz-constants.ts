 ...
 */
const VOLUME_RATIOS = {
  // ⚠️ IMPORTANT : Ces ratios représentent le volume TOTAL déménagement
  // (mobilier complet) selon le modèle La Poste / Carrefour :
  // ~30% de la surface habitable convertie en m³.
  studio: 0.30,
  t1: 0.30,
  t2: 0.30,
  t3: 0.30,
